...
public interface HomePageMapper {
	HomePage getHomePage(@Param("findchild") boolean findchild,@Param("siteid") Integer siteId,@Param("starttime") String startTime,@Param("endtime") String endTime,@Param("type") String type,@Param("total") String total);
	
	ArrayList<HomePageByZonetype> getHomePageByZonetype(@Param("findchild") boolean findchild,@Param("siteid") Integer siteId,@Param("starttime") String startTime,@Param("endtime") String endTime,@Param("type") String type,@Param("zoneType") Integer zoneType);
	
	ArrayList<HomePage> getTotalData(@Param("findchild") boolean findchild,@Param("siteid") Integer siteId,@Param("starttime") String startTime,@Param("endtime") String endTime,@Param("type") String type,@Param("total") String total);

	ArrayList<HomePageByTag> getHomePageByTag(@Param("findchild") boolean findchild,@Param("siteid") Integer siteId,@Param("starttime") String startTime,@Param("endtime") String endTime,@Param("type") String type,@Param("tagType") String tagType);
	
	ArrayList<HomePageByLocation> getHomePageByLocation(@Param("findchild") boolean findchild,@Param("siteid") Integer siteId,@Param("starttime") String startTime,@Param("endtime") String endTime,@Param("type") String type,@Param("locationType") Integer locationType);
